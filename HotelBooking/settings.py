...
SECRET_KEY = '(8f=un8*w^uhoi!iints152_o=t&w6n7p#)p+4fta8hoyp!z^)'
...
INSTALLED_APPS = [
    ...
    'HotelBooking','superuser','manager','user'
]
...
EMAIL_USER_TLS = True
EMAIL_POSR = 587
EMAIL_HOST_USER ='akankshag503@gmail.com'
EMAIL_HOST_PASSWORD = '040598@AK'
